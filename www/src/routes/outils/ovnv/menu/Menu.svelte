...
<svg id="cercle_chargement" viewBox="-1000 -1000 2000 2000">
    {#if etapes_chargement == "cercle_chargement"}
        ...
        cx="0" cy="0" r="800" fill="none" stroke="white" stroke-width="20" />
    {/if}
</svg>
...
<div id="menu">
    {#if etapes_chargement == "affichage_menu"}
        <div 
            ...
            on:click={nouveau_projet} role="none" >
            <h2>Nouveau projet</h2>
        </div>
    {/if}
    {#if etapes_chargement == "affichage_menu"}
        <div 
            in:fade={{delay:500, duration: 500}} id="continuer"
            on:click={importer_projet} role="none"
        >
