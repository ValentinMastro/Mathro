...
<Contenu>
    <Partie numero={2} titre="Multiplier et diviser par 1, 10, 100, 1000, etc." />
        ...
        <Methode lignes={4}>
            <Item lignes={2}>
                Multiplier par 1, 10, 100, 1000, etc. revient à déplacer la virgule vers la droite.
            </Item>
            <Item lignes={2}>
                Diviser par 1, 10, 100, 1000, etc. revient à déplacer la virgule vers la gauche.
            </Item>
        </Methode>
        <Remarque lignes={4}>
