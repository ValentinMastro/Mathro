...
export let sommaire_6eme: Chapitre[] = [
	...
	{
		titre: 'Vocabulaire de géométrie',
		categories: ['Espace et géométrie'],
		attendus: ['Rappel : vocabulaire de géométrie (segment, droite, demi-droite, milieu)', 'Alignement, appartenance', 'Constructions']
	},
	{
		titre: 'Fraction/Partage',
		categories: ['Nombres et calculs'],
		attendus: [
			'Partages d’unités',
			'Repérage sur une demi-droite graduée',
	...
	{
		titre: 'Addition, Soustraction et Multiplication',
		categories: ['Nombres et calculs'],
		attendus: [
	...
	},
	{
		...
		categories: ['Nombres et calculs', 'Grandeurs et mesures'],
		attendus: ['Multiplier, diviser par 10, 100, 1 000', 'Convertir des unités de longueurs ou de masse']
	},
	{
	...
	},
	{
		...
		categories: ['Espace et géométrie', 'Grandeurs et mesures'],
		attendus: [
	...
	{
		titre: 'Durées, Horaires',
		categories: ['Grandeurs et mesures'],
		attendus: [
	...
	{
		titre: 'Volumes et contenances',
		categories: ['Espace et géométrie', 'Grandeurs et mesures'],
		attendus: ['Unités de volume et de contenance et conversions', 'Formules du volume d’un cube, d’un pavé droit']
	},
	{
		titre: 'Se repérer',
		categories: ['Espace et géométrie', 'Algorithmique et programmation'],
		attendus: [
	...
	{
		titre: 'Propriétés des droites',
		categories: ['Espace et géométrie'],
		attendus: ['Propriétés des droites parallèles et des droites perpendiculaires']
	},
	{
		titre: 'Représentations usuelles',
		categories: ['Grandeurs et mesures'],
		attendus: [
	...
	},
	{
		...
		categories: ['Espace et géométrie'],
		attendus: ['Reproduire une figure en respectant une échelle donnée', 'Agrandissement ou réduction d’une figure']
	}
];

export let sommaire_5eme: Chapitre[] = [
	// Période 1
	{
		titre: 'Fractions',
		categories: ['Nombres et calculs'],
	...
	{
		titre: 'Propriétés de la symétrie',
		categories: ['Espace et géométrie'],
		attendus: [
	...
	// Période 3
	{
		titre: 'Construire des symétriques',
		categories: ['Espace et géométrie'],
		attendus: [
	...
	{
		titre: 'Calculer avec des relatifs',
		categories: ['Nombres et calculs'],
		attendus: [
	...
	{
		titre: 'Droites remarquables dans un triangle',
		categories: ['Espace et géométrie'],
		attendus: [
	...
	// Période 4
	{
		titre: 'Situations de proportionnalité',
		categories: ['Nombres et calculs'],
		attendus: [
	...
	{
		titre: 'Tableaux et statistiques',
		categories: ['Organisation et gestion de données'],
		attendus: [
	...
	{
		titre: 'Utiliser la proportionnalité',
		categories: ['Nombres et calculs'],
		attendus: [
	...
	},
	{
		titre: 'Angles',
		categories: ['Espace et géométrie'],
		attendus: ['Connaître les caractérisations angulaires du parallélisme (angles alternes internes, angles correspondants)']
	},
	{
		titre: 'Diagrammes et graphiques',
		categories: ['Organisation et gestion de données'],
		attendus: [
	...
	},
	{
		titre: 'Probabilités',
		categories: ['Organisation et gestion de données'],
		attendus: ['Placer un événement sur une échelle de probabilités', 'Calculer des probabilités dans des situations simples d’équiprobabilité']
	},
	{
		titre: 'Dépendance de grandeurs',
		categories: ['Grandeurs et mesures'],
		attendus: [
...
export let sommaire_4eme: Chapitre[] = [
