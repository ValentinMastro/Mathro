...
export { default as Donc } from './Donc.svelte';
...
export { default as OnSaitQue } from './OnSaitQue.svelte';
export { default as Or } from './Or.svelte';
export { default as PourMieuxComprendre } from './PourMieuxComprendre.svelte';
export { default as Propriete } from './Propriete.svelte';
export { default as Proprietes } from './Proprietes.svelte';
