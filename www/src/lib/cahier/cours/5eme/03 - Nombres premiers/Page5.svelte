...
<Contenu>
	<Partie numero={4} titre="Application du théorème : simplifier des fractions" />
	<Methode lignes={3}>
		Pour simplifier une fraction, on peut écrire la décomposition en produit de facteurs premiers du numérateur et du dénominateur, puis simplifier en
		divisant par les facteurs communs.
	</Methode>
	<Exemples lignes={9}>
		<Item lignes={4}>
