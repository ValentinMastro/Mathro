...
<Contenu apres_un_titre>
	<Definition>Le volume d'un solide est la mesure de l'espace qu'il délimite.</Definition>
	<Definition>La contenance mesure l'espace contenu dans un solide.</Definition>
