...
<Contenu>
	<Partie numero={4} titre="Multiplier et diviser par 1, 10, 100, 1000, etc." />
	<Methode lignes={4}>
	...
	<Exemples lignes={3}>
		...
		<Item>{@html math(`3{,}14 \\div ${pow10} = ${quotient}`)}</Item>
		<Item>{@html math(`3{,}14 \\times ${pow10Neg} = ${quotient}`)}</Item>
	</Exemples>
</Contenu>
