...
<DansLaMarge lignes_vides={14}>
	<Slider bind:valeur={longueur} min={1} max={5} />
</DansLaMarge>
	...
	<Schema lignes={10} aspectRatioSVG={2}>
		{#snippet svg()}
			...
			{#each Array(longueur) as _, i}
				{#each Array(longueur) as _, j}
					<polygon
						points="{cx},{cy} {cx},{cy + 100} {cx + 100 * cos(30)},{cy + 100 - 100 * sin(30)} {cx + 100 * cos(30)},{cy - 100 * sin(30)}"
						fill="red"
						stroke="black"
						stroke-width="8"
					...
					/>
					<polygon
						points="{cx - 200},{cy - 100} {cx - 200},{cy} {cx - 100 * cos(30) - 200},{cy - 100 * sin(30)} {cx - 100 * cos(30) - 200},{cy -
							100 * sin(30) -
							100}"
						fill="green"
						stroke="black"
					...
					/>
					<polygon
						points="{cx - 100},{cy - 100 * sin(30)} {cx - 100 - 100 * cos(30)},{cy} {cx - 100},{cy + 100 * sin(30)} {cx - 100 + 100 * cos(30)},{cy} Z"
						fill="blue"
						stroke="black"
						stroke-width="8"
