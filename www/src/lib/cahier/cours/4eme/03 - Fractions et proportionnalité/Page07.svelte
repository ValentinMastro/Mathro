...
<Contenu>
	...
	<Propriete lignes={3}>
		...
		<center>
			<math>
				<mtext>taux de variation</mtext>
				<mo>=</mo>
				<mfrac>
					<mrow>
						<mtext>valeur d'arrivée</mtext>
						<mo>-</mo>
						<mtext>valeur de départ</mtext>
					</mrow>
					<mtext>valeur de départ</mtext>
				</mfrac>
				<mo>×</mo>
	...
	<Exemples lignes={10}>
		<Item lignes={4}>
			Le nombre d'habitants d'une ville est passé de 4 000 à 5 000,
			<br />
		...
		<Item lignes={6}>
			...
			Aujourd'hui, elle ne vaut plus que 5 000 €.
			<br />
			Calculons son taux de variation :
			<br />
			<center>
				<math>
					<mfrac>
