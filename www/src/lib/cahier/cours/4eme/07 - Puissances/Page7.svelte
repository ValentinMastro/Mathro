<script lang="ts">
	...
	import { Definition, Exemples, Item, Remarque, Propriete, Texte } from '$lib/cahier/composants/de_cours/*';
</script>
...
<Contenu>
	...
	<Remarque>
		Pour n'importe quelle base <math><mi>a</mi></math>
		, on a
		<math>
			<msup>
				<mi>a</mi>
	...
	<Propriete>
		Pour tout nombre <math><mi>x</mi></math>
		,
		<math>
			<msup>
				<mi>x</mi>
