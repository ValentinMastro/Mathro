<script lang="ts">
    ...
    import { Definition, Exemples, Remarque, Schema, Notation, Formule, Propriete, Paragraphe } from "$lib/chapitrage/sections/all_sections";
...
<Chapitre numero={6} titre="Cercle, centre, milieu, médiatrice" >
    <Partie numero={1} titre="Cercle" >
        ...
        <Formule>
            ...
            {@html display(`𝒫_{cercle} = 2 \\times \\pi \\times r`)}
        </Formule>
        <Exemples>
        ...
        <Remarque>
            Le nombre {@html math("\\pi")} vaut environ 3,14.
        </Remarque>
    </Partie>
