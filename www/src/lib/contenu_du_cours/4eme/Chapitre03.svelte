<script lang="ts">
    ...
    import { Definition, Exemples, Propriete, Schema, Notation } from '$lib/chapitrage/sections/all_sections';
    ...
    <Partie numero={3} titre="Translation">
        ...
        <Notation>
            <ul>
                ...
                <li>La translation de vecteur {@html math("\\overrightarrow{\\text{AA}'}")}</li>
